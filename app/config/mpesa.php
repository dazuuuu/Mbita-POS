...
return [
    ...
    // Set your M-Pesa callback URL when deploying (use app_url('api/billing/mpesa_callback.php')).
    'callback_url' => 'https://your-domain.example' . '/Curlz/public/api/billing/mpesa_callback.php',
