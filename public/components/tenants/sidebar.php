<?php
// public/components/tenants/sidebar.php — TRACK-style sidebar for super/owner
$__tenant   = $__tenant ?? null;
$shopName   = $__tenant['name'] ?? 'My Shop';
$username   = $_SESSION['username'] ?? 'User';
$uri        = $_SERVER['REQUEST_URI'] ?? '';
$isOwner    = TenantContext::role() === 'tenant_owner';
$dashUrl    = $isOwner ? '/Curlz/public/super/dashboard/' : '/Curlz/public/staff/dashboard/';
...
if (TenantContext::can(Capabilities::INVENTORY_EDIT)) {
...
if ($isOwner) {
    $nav[] = ['href' => '/Curlz/public/super/services/', 'icon' => 'fa-briefcase', 'label' => 'Services', 'active' => $isOn('/super/services')];
...
if (TenantContext::can(Capabilities::BRANCHES_MANAGE)) {
