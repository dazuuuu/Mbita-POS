...
if (empty($_SESSION['reset_user_id'])) {
    header('Location: /Curlz/public/auth/forgot-password.php');
    exit;
}
...
<div class="auth-foot">
    Didn't get it? <a href="/Curlz/public/auth/reset-otp.php?resend=1">Resend code</a><br>
    <a href="/Curlz/public/auth/forgot-password.php">Try a different email</a>
</div>
<?php
