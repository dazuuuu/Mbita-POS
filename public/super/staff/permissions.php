...
$groups = [
    ...
    'Sales' => [
        ...
        [Capabilities::COMMISSION_RECORD, 'Record commissioned sales', 'Log service/product sales and earn commission'],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $staffId) {
    ...
    if ($staff) {
        ...
        header('Location: /Curlz/public/super/staff/permissions.php?staff=' . $staffId);
        exit;
    }
...
<?php else: ?>
  ...
  <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
    ...
    <a class="btn btn-sm btn-outline-secondary" href="/Curlz/public/super/staff/permissions.php"><i class="fas fa-arrow-left me-1"></i>All staff</a>
  </div>
  ...
  <form method="post">
    ...
    <div class="d-flex gap-2">
      ...
      <a class="btn btn-outline-secondary" href="/Curlz/public/super/staff/permissions.php">Cancel</a>
    </div>
  </form>
